...
def applyRandomForest(dataFrame,new_ClassLabel,feature_list_toDrop,subtree,max_depth):
    ...
    plt.figure(figsize=(34, 10),dpi=300)
    ...
    plt.xlabel('srcPort_dstPort_Protocol (3-tuple flowID)', fontsize=40)
    plt.ylabel('Flow Duration (in Hours)', fontsize=40)
    plt.title('Top 75 DDoS flows predicted by Random Forest', fontsize=40)
    plt.xticks(rotation=45, ha='right')
    plt.tight_layout()
    plt.legend(['DDoS flow info vs flow duration'],fontsize=40)
...
if __name__ == "__main__":
    ...
    plt.plot(xaxis, yaxis, label='DDoS Algorithm Accuracy',linewidth=3)
    # ax.text(2, 20, 'Text Here', fontsize=12, color='red')
    plt.xlabel('Machine Learning Algorithm', fontsize=40)
    plt.ylabel('Accuracy', fontsize=40)
    plt.title('Accuracy of Machine Learning Algorithm  to predict DDoS Traffic', fontsize=40)
